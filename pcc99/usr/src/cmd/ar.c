...
int16_t	signum[] = {SIGHUP, SIGINT, SIGQUIT, 0};
int16_t	sigdone();
int32_t	lseek();
int16_t	rcmd();
int16_t	dcmd();
...
void bamatch(void);
int16_t cleanup(void);
int16_t copyfil(int16_t fi, int16_t fo, int16_t flag);
int16_t done(int16_t c);
int16_t getaf(void);
int16_t getdir(void);
int16_t getqf(void);
int16_t init(void);
int16_t install(void);
int16_t longt(void);
int16_t match(void);
int16_t mesg(int16_t c);
int16_t morefil(void);
int16_t movefil(int16_t f);
int16_t noar(void);
int16_t notfound(void);
int16_t phserr(void);
int16_t pmode(void);
int16_t select(int16_t *pairp);
int16_t stats(void);
char * trim(char *s);
int16_t usage(void);
int16_t wrerr(void);
...
int16_t init(void)
{
	...
	if (write(tf, (char *)&mbuf, sizeof(int16_t)) != sizeof(int16_t))
		wrerr();
}
...
int16_t getaf(void)
{
	...
	if(af < 0)
		return(1);
	if (read(af, (char *)&mbuf, sizeof(int16_t)) != sizeof(int16_t) || mbuf!=ARMAG) {
...
int16_t getqf(void)
{
	...
	if ((qf = open(arnam, 2)) < 0) {
		...
		mbuf = ARMAG;
		if (write(qf, (char *)&mbuf, sizeof(int16_t)) != sizeof(int16_t))
			wrerr();
	}
	else if (read(qf, (char *)&mbuf, sizeof(int16_t)) != sizeof(int16_t)
		|| mbuf!=ARMAG) {
		fprintf(stderr, "ar: %s not in archive format\n", arnam);
		done(1);
	}
...
int16_t	m1[] = { 1, ROWN, 'r', '-' };
int16_t	m2[] = { 1, WOWN, 'w', '-' };
int16_t	m3[] = { 2, SUID, 's', XOWN, 'x', '-' };
int16_t	m4[] = { 1, RGRP, 'r', '-' };
int16_t	m5[] = { 1, WGRP, 'w', '-' };
int16_t	m6[] = { 2, SGID, 's', XGRP, 'x', '-' };
int16_t	m7[] = { 1, ROTH, 'r', '-' };
int16_t	m8[] = { 1, WOTH, 'w', '-' };
int16_t	m9[] = { 2, STXT, 't', XOTH, 'x', '-' };

int16_t	*m[] = { m1, m2, m3, m4, m5, m6, m7, m8, m9};
