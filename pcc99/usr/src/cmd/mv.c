...
int16_t check(char *spth, ino_t dinode);
int16_t chkdot(char *s);
char * dname(char *name);
int16_t move(char *source, char *target);
int16_t mvdir(char *source, char *target);
char * pname(char *name);

int16_t main(int16_t argc, char *argv[])
{
	register int16_t i, r;
