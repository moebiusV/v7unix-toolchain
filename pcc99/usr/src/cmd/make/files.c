...
static int16_t amatch(char *s, char *p);
int16_t clarch(void);
...
static int16_t umatch(char *s, char *p);
...
#ifdef METERFILE
#include <pwd.h>
int16_t meteron	= 0;	/* default: metering off */
