...
static int16_t comsubst(void);
static int16_t flush(int16_t ot);
static int16_t getch(CHAR endch);

static STRING copyto(CHAR endch)
{
	REG CHAR	c;
...
static int16_t skipto(CHAR endch)
{
	/* skip chars up to } */
	REG CHAR	c;
