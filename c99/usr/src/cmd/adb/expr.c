...
int16_t chkloc(L_INT frame);
int16_t convdig(CHAR c);
int16_t digit(char c);
int16_t eqsym(STRING s1, STRING s2, CHAR c);
int16_t hexdigit(CHAR c);
int16_t item(int16_t a);
SYMPTR lookupsym(STRING symstr);
int16_t readsym(void);
int16_t symchar(int16_t dig);
int16_t term(int16_t a);
int16_t varchk(int16_t name);

int16_t expr(int16_t a)
...
int16_t digit(char c){return(c>='0' ANDF c<='9');}

int16_t letter(char c){return(c>='a' ANDF c<='z' ORF c>='A' ANDF c<='Z');}
